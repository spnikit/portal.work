...
public class FPU26PPSDropController extends AbstractController {
	
	public FPU26PPSDropController() {
		}
	...
	//		"<body BGCOLOR=#e6f6ff><center><h2>Пожалуйста, подождите.</h2></center><p><center><h2>Документ сохраняется.</h2></center>" +
		"<script type=\"text/javascript\">history.back();parent.fpu26ppsdrop();</script></body></html>");
		return null;
