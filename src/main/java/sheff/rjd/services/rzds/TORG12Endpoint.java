...
import ru.iit.rzds.torg12.AddrIn;
import ru.iit.rzds.torg12.AddrRf;
import ru.iit.rzds.torg12.Table;
import ru.iit.rzds.torg12.Torg12RequestDocument;
import ru.iit.rzds.torg12.Torg12RequestDocument.Torg12Request;
import ru.iit.rzds.torg12.Torg12RequestDocument.Torg12Request.BuyerInf;
import ru.iit.rzds.torg12.Torg12ResponseDocument;
import ru.iit.rzds.torg12.Torg12ResponseDocument.Torg12Response;
import ru.iit.rzds.torg12.Varantyinfo;

public class TORG12Endpoint extends
...
//		int count  = getNpjt()
//				.queryForInt(
//						"select count(0) from snt.docstore where etdid = :actid",
//						hm);
//		
//		if (count==0){
...
//			throw new ServiceException(new Exception(), ServiceError.ERR_ACTTMC_NOTARCHIVE);
		...
		try {
			...
			// Gruzotpr
//			binder.setNodeValue("P_1a", req.getGruzOtprInf().getGruzOtprName());
			binder.setNodeValue("P_1", req.getGruzOtprInf().getGruzOtprName());
			if (req.getGruzOtprInf().isSetGruzOtprTel())
				binder.setNodeValue("P_1v", req.getGruzOtprInf()
						.getGruzOtprTel());
			if (req.getGruzOtprInf().isSetGruzOtprFax())
				binder.setNodeValue("P_1g", req.getGruzOtprInf()
						.getGruzOtprFax());
			if (req.getGruzOtprInf().isSetGruzOtprBankname())
				binder.setNodeValue("P_1d", req.getGruzOtprInf()
						.getGruzOtprBankname());
			if (req.getGruzOtprInf().isSetGruzOtprSchet())
				binder.setNodeValue("P_1e", req.getGruzOtprInf()
						.getGruzOtprSchet());
			if (req.getGruzOtprInf().isSetGruzOtprKorschet())
				binder.setNodeValue("P_1j", req.getGruzOtprInf()
						.getGruzOtprKorschet());
			if (req.getGruzOtprInf().isSetGruzOtprBik())
				binder.setNodeValue("P_1z", req.getGruzOtprInf()
						.getGruzOtprBik());
			if (req.getGruzOtprInf().isSetGruzOtprInn())
				binder.setNodeValue("P_1i", req.getGruzOtprInf()
						.getGruzOtprInn());
			if (req.getGruzOtprInf().isSetGruzOtprKpp())
				binder.setNodeValue("P_1k", req.getGruzOtprInf()
						.getGruzOtprKpp());
			if (req.getGruzOtprInf().isSetGruzOtprOkpo())
				binder.setNodeValue("P_2", req.getGruzOtprInf()
						.getGruzOtprOkpo());
			...
			if (req.getGruzOtprInf().getGruzOtprAddress().isSetARf()) {
				...
				sb.append("Россия, ");
				if (req.getGruzOtprInf().getGruzOtprAddress().getARf()
						.isSetInd()) {
					sb.append(req.getGruzOtprInf().getGruzOtprAddress()
							.getARf().getInd());
					sb.append(", ");
				}
				// if
...
//								.toString());
			...
			if (req.getGruzPolInf().getGruzPolAddress().isSetARf()) {
				...
				if (req.getGruzPolInf().getGruzPolAddress().getARf().isSetInd()) {
					sb.append(req.getGruzPolInf().getGruzPolAddress().getARf()
							.getInd());
					sb.append(", ");
				}
				// if
				...
				if (req.getGruzPolInf().getGruzPolAddress().getARf()
						.isSetRaion()) {
					sb.append(req.getGruzPolInf().getGruzPolAddress().getARf()
							.getRaion());
					sb.append(", ");
			...
			binder.setNodeValue("P_1g", req.getPostInf().getPostSchet());
			binder.setNodeValue("P_1d", req.getPostInf().getPostBankname());
			binder.setNodeValue("P_1e", req.getPostInf().getPostBik());
			binder.setNodeValue("P_1j", req.getPostInf().getPostKorschet());
			...
			if (req.getPostInf().getPostAddress().isSetARf()) {
				...
				if (req.getPostInf().getPostAddress().getARf().isSetInd()) {
					sb.append(req.getPostInf().getPostAddress().getARf()
							.getInd());
					sb.append(", ");
				}
			...
			if (req.getBuyerInf().getBuyerAddress().isSetARf()) {
				...
				if (req.getBuyerInf().getBuyerAddress().getARf().isSetInd()) {
					sb.append(req.getBuyerInf().getBuyerAddress().getARf()
							.getInd());
					sb.append(", ");
				}
			...
			binder.fillTable(
					TypeConverter.arrayToArrayList(req.getTorgTabArray()),
					new DataRowMapper<Table>() {
			...
			binder.setNodeValue("okpo_code_sell", req.getOkpoCodeSell());
			binder.setNodeValue("okpo_code_buy", req.getOkpoCodeBuy());
			
			

			Map<String, Object> map = new HashMap<String, Object>();
			map.put("okpo", req.getOkpoCodeSell());
...
//			map.put("di", "08");
			map.put("dogovor",
					binder.getValue("P_8") + " от " + binder.getValue("P_9"));
//			map.put("onbaseid", Integer.parseInt(binder.getValue("P_59")));
//			map.put("repdate", binder.getValue("P_44"));
			map.put("id_pak", req.getIdPak());
			map.put("content", req.getDocnumber());
			npjt.update(
					"update snt.docstore set readid = 1, no =:dogovor, id_pak = :id_pak, opisanie =:content where id =:ID ",
					map);
	...
	protected Object composeResponce(
		...
		Torg12ResponseDocument responsedoc = Torg12ResponseDocument.Factory
				.newInstance();
