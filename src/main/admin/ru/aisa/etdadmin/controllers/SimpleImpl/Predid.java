...
public class Predid extends AbstractSimpleController{

	public Predid() throws JSONException{
		super();
	}
	...
	public JSONArray get(HttpServletRequest request) {
		...
		String sql = "select id, rtrim(name) name from snt.pred where headid is null";
