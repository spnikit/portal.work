...
public class Adresses extends AbstractSimpleController{
	...
	public JSONArray get(HttpServletRequest request){
		...
		getNpjt().query("select id, adress from snt.join_adresses", new HashMap(), new ParameterizedRowMapper(){

			public Object mapRow(ResultSet rs, int arg1) throws SQLException {
				// TODO Auto-generated method stub
					JSONArray js = new JSONArray();
					js.put(rs.getInt("id"));
					js.put(rs.getString("adress"));	
