...
if (!supportProps.isDOMStandart) {
	...
	window.DOMException = function DOMException(code, message) {
	 ...
	 *      collection is implemented. NodeList objects in the DOM are live. The
	 *      items in the NodeList are accessible via an integral index, starting
	 *      from 0.
	 */
	...
	NodeList.prototype = {
		 ...
		 * @return Node The node at the indexth position in the NodeList, or
	 ...
	 * NamedNodeMap objects in the DOM are live. used for attributes or
	 * DocumentType entities
	 */
	window.NamedNodeMap = function NamedNodeMap() {
	};
	 ...
	 * attributes; children;
	 * 
	 * writeable properties: nodeValue,Attr:value,CharacterData:data prefix
	 */
	...
	window.CharacterData = function CharacterData() {
	};
	...
	window.Notation = function Notation() {
	};
	...
	window.EntityReference = function EntityReference() {
	};
	...
	window.ProcessingInstruction = function ProcessingInstruction() {
	}
	ProcessingInstruction.prototype.nodeType = PROCESSING_INSTRUCTION_NODE;
	_extends(ProcessingInstruction, Node);
	window.XMLSerializer = function XMLSerializer() {
	}
	...
	function importNode(doc, node, deep) {
		...
		switch (node.nodeType) {
			case ELEMENT_NODE :
				...
				var len = attrs.length;
				for (var i = 0; i < len; i++) {
					node2.setAttributeNodeNS(importNode(doc, attrs.item(i),
							deep));
				}
			case DOCUMENT_FRAGMENT_NODE :
				break;
	...
	//
	// var _relationMap =
	// {firstChild:1,lastChild:1,previousSibling:1,nextSibling:1,
