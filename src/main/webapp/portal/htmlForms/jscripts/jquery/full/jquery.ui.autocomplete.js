 ...
 * 
 * Copyright 2012, AUTHORS.txt (http://jqueryui.com/about) Dual licensed under
	...
	$.widget("ui.autocomplete", {
		...
		_create : function() {
			...
			this.menu = $("<ul></ul>").addClass("ui-autocomplete").appendTo($(
					...
					.mousedown(function(event) {
						...
						// blur-event-handler on the
						// input was already triggered
						setTimeout(function() {
		...
		_initSource : function() {
			...
			if ($.isArray(this.options.source)) {
				...
				console.info(this.options.source);
