...
public abstract class ETDAbstractSecurityUserEndpoint<T,E> extends		AbstractMarshallingPayloadEndpoint 
{
	...
	protected ETDAbstractSecurityUserEndpoint(Marshaller marshaller) {
		super(marshaller);
	}
	...
	protected Object invokeInternal(Object arg) throws Exception 
	{
		...
		try
		{
			...
			if (requestDocument instanceof FormTypesRequestDocument
				...
				validSignature = getSecurityManager().checkAuthSignature(s.getUsername(), s.getSign(), s.getCertid());
			}
