...
public class SchetCSSController extends AbstractAction{
			...
			try{
				...
				for (int i=0;i<ids.size(); i++) {
					try {
						...
						List<Map<String, Object>> l = npjt.queryForList("select typeid, " +
								"(select rtrim(name) docname from snt.doctype where id = ds.typeid), " +
